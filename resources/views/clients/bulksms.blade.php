@extends('layouts.vertical', ['title' => 'List Bulk SMS'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">List Bulk SMS</li>
                        </ol>
                    </div>
                    <h4 class="page-title">List Bulk SMS</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
