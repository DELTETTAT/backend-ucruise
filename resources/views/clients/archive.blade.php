            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="javascript:;" data-toggle="modal" data-target="#sendEmail" class="btn btn-info" style="float: left;">Send Bulk Email</a> 
                      ...
                      <a href="{{url('users/listEmails/type')}}" class="btn btn-info dd" style="float: left;">List Emails</a>

                    <a href="javascript:;" data-toggle="modal" data-target="#sendSMS" class="btn btn-info sms" style="float: left;">Send SMS</a>

                    <a href="{{url('users/listSMS/type')}}" class="btn btn-info dd" style="float: left;">List SMS</a> 
                    ...
                    */
                    ...
                    <table class="table table-design-default ">
                        ...
                        <tbody>
                            @if(count($arcchivedClient) > 0 )
                            @foreach($arcchivedClient as $key1=>$data)
                            <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success action_btn" href="{{route('unurchiveClient',[$data->id])}}" onclick="return confirm('Are you sure you want to Unarchive this?')" style="margin: unset;
