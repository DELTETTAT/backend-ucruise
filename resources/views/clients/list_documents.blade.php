@extends('layouts.vertical', ['title' => 'List Clients Documents'])
@section('css')
<!-- Plugins css -->
         ...
         <div class="page-title-box">
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">List Driver Documents </li>
               </ol>
            </div>
            <h4 class="page-title"><a href="{{route('clients.show',[$cId])}}"><i data-feather="arrow-left"></i></a>List Clients Documents</h4>
         </div>
      </div>
   </div>
   <!-- end page title -->
               ...
               <table id="basic-datatable" class="table dt-responsive table-hover table-bordered nowrap w-100">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="javascript:;" data-toggle="modal" data-target="#expire{{$key1}}">
                              @if($data->expire == "")
                              {{'........'}}
                        ...
                        <td style="text-align:center">
                           <form action="{{route('updateClientNoExpireation',[$data->id])}}" method='post' enctype="multipart/form-data" class="check{{$key1}}">
                              @csrf
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 <form action="{{route('updateClientDocCategory',[$data->id])}}" method='post' enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="redirect" value="qc">
                                    <div class="form-group">
                                       <label>Document Category <code>*</code></label>
                                       <select name="category" class="form-control">
                                          <option value="">Select</option>
                                          @foreach($docCategory as $dCate)
                                          <option value="{{$dCate->category_name}}" <?php if ($data->category == $dCate->category_name) {
                                                                                       echo 'selected';
                                                                                    } ?>>{{$dCate->category_name}}</option>
                                          @endforeach
                                       </select>
                                    </div>
                                    <div class="form-group">
                     ...
                     <!-- For doc category -->
                     <!-- Set expire date -->
                     <div class="modal fade" id="expire{{$key1}}" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                           <div class="modal-content">
                              <div class="modal-header">
...
<div class="modal fade" id="doc" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form action="{{route('uploadClientDocument',[$cId])}}" method='post' enctype="multipart/form-data">
               @csrf
               <input type="hidden" name="redirect" value="qc">
               <div class="form-group">
                  <label>File <code>*</code></label>
