@extends('layouts.vertical', ['title' => 'Add Notes'])
@section('content')
<!-- Start Content-->
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-12">
         <div class="page-title-box">
            ...
            <h4 class="page-title">{{\Request::route()->getName()}}</h4>
         </div>
      </div>
   </div>
   <!-- end page title --> 
   <div class="row">
      <div class="col-lg-12 card">
         ...
         <form method="POST" action="{{ route('note.store') }}" enctype="multipart/form-data" name="gift_store">
            {{ csrf_field() }}
            <div class="card-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Heading Name <code>*</code></label>
                         <input type="text" name="heading" class="form-control"   required="" placeholder="Heading Name">
                     </div>
