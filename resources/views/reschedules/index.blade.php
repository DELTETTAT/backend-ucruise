                ...
                <div class="card-body">
                    ...
                    <table class="table table-design-default">
                        ...
                        <tbody id="ajax_container">
                            ...
                            <tr>
                                <td>{{$loop->index + 1}}</td>
                                <td>{{$reschedule->user->first_name . ' ' . $reschedule->user_last_name}}</td>
                                <td>{{$reschedule->address}}</td>
                                <td>{{$reschedule->latitude}}</td>
                                <td>{{$reschedule->longitude}}</td>
                                <td><a href="{{route('acceptReschedule', $reschedule->id)}}">Accept</a></td>
                                <td><a href="{{route('rejectReschedule', $reschedule->id)}}">Reject</a></td>
                            </tr>
                            @endforeach
                        </tbody>
