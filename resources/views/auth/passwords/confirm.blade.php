                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Success !</h3>
                                    <p class="text-muted font-14 mt-2"> Congratulations! You have successfully changed password, Now you can login. </p>

                                    <a href="{{url('admin/login')}}" class="btn btn-block btn-pink waves-effect waves-light mt-3">Back to Home</a>
                                </div>
