...
<style>
    ...
    <body class="authentication-bg authentication-bg-pattern">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            @endif   -->
                                ...
                                <form action="{{ route('staff') }}" method="POST" novalidate>
                                    @csrf

                                    <div class="form-group mb-3">
                                        <label for="emailaddress">Login Id</label>
                                        <input class="form-control  @if($errors->has('email')) is-invalid @endif" name="unique_id" type="email" 
                        ...
                        <!-- <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-white-50">Don't have an account? <a href="" class="text-white ml-1"><b>Sign Up</b></a></p>
                            </div>
                        </div> -->
                        <!-- end row -->
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy;<a href="" class="text-white-50">ShiftCare</a> 
        </footer>
