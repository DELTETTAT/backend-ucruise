@extends('layouts.vertical', ['title' => 'Edit Team'])
@section('content')
<style>
...
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-lg-12 card">
         ...
         <form method="POST" action="{{ route('updateTeam',[$edit->id])}}" enctype="multipart/form-data" name="gift_store">
            ...
            <div class="card-body">
               <div class="form-group">
                  <div class="row">
                     ...
                     <?php
                      $ids = explode(',',$edit->staff);
                     ?>
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Name <code>*</code></label>
                         <input type="text" name="name" class="form-control" value="{{$edit->name}}"   required="" placeholder="Team`s Name"> 
                     </div>
                     ...
                     <div class="col-sm-6 mt-2 role" >
                        ...
                        <select class="form-control js-example-basic-single" multiple="multiple" name="staff[]" required="">
                             ...
                             <option value="{{$data->id}}" <?php if (in_array($data->id, $ids)) { echo 'selected'; } ?>>{{ucfirst($data->first_name)}}</option>
                             @endforeach
                         </select> 
                     </div>
