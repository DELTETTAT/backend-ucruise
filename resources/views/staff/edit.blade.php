               ...
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-sm-6 mt-2">
                        ...
                        <input type="text" name="email"  class="form-control" value="{{$edit->email}}" required="" placeholder="Email" readonly>
                     </div>
                     ...
                     <div class="col-sm-6 mt-2">
                        ...
                        <select class="form-control" name="employement_type" required="">
                           <option disabled="">Select</option>
                           <option value="Employee" <?php if ($edit->employement_type == 'Employee') {
                                                         echo 'selected';
                                                      } ?>>Employee</option>
                           <option value="Contractor" <?php if ($edit->employement_type == 'Contractor') {
                                                         echo 'selected';
                                                      } ?>>Contractor</option>
                     ...
                     <div class="col-sm-6 mt-2">
                        ...
                        <input type="hidden" id="postalCode" name="postalCode" value="{{$edit->postalCode}}">
                     </div>
