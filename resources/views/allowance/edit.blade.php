@extends('layouts.vertical', ['title' => 'Edit Allowance'])
@section('content')
<style>
...
<div class="container-fluid">
         ...
         <div class="page-title-box">
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Allowance</a></li>
               </ol>
            </div>
            <h4 class="page-title">Edit Allowance</h4>
         </div>
      </div>
   </div>
   <!-- end page title --> 
   <div class="row">
      <div class="col-lg-12 card">
         ...
         <form method="POST" action="{{ route('allowance.update',[$edit->id])}}" enctype="multipart/form-data" name="gift_store">
                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Name <code>*</code></label>
                         <input value="{{$edit->name}}" type="text" name="name" class="form-control"   required="" placeholder="Name">
                     </div>
                     ...
                     <div class="col-sm-6 mt-2 role" >
                        ...
                        <select class="form-control js-example-basic-single"  name="type" required="">
                             ...
                             <option <?php if($edit->type== $value->id){ echo 'selected'; } ?> value="{{$value->id}}">{{$value->name}}</option>
                             @endforeach
                     ...
                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Value <code>*</code></label>
                         <input type="number" value="{{$edit->value}}" name="value" class="form-control"   required="" placeholder="Value">
                     </div>

                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Xero pay Item <code>*</code></label>
                         <input type="text" value="{{$edit->xero_pay_item}}" name="xero_pay_item" class="form-control"   required="" placeholder="Xero pay Item">
                     </div>
