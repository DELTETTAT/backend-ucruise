...
<div class="container-fluid">
         ...
         <div class="page-title-box">
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="javascript: void(0);">Edit Subscription</a></li>
               </ol>
            </div>
   ...
   <div class="row">
      <div class="col-lg-12 card">
         ...
         <form method="POST" action="{{ route('subscription.update',[$edit->id])}}" enctype="multipart/form-data" name="gift_store">
            {{ csrf_field() }}
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Title <code>*</code></label>
                         <input type="text" name="title" class="form-control"   required="" placeholder="Title" value="{{$edit->title}}">
                     </div>

                     <div class="col-sm-6 mt-2">
                        <label for="exampleInputName1">Price <code>*</code></label>
                         <input type="number" name="price" class="form-control"   required="" placeholder="Price" value="{{$edit->price}}">
                     </div>
                     ...
                     <div class="col-sm-6 mt-2">
                                ...
                                <option disabled="">Select</option>
                                    ...
                                    @foreach($features as $feature)
                                        <option value="{{$feature->id}}" {{ in_array($feature->id, $edit->features->pluck('id')->toArray()) ? 'selected' : '' }}>
                                            {{$feature->name}}
