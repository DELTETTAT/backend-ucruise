@extends('layouts.vertical', ['title' => 'Add Reminder'])
@section('content')
<!-- Start Content-->
<div class="container-fluid">
   ...
   <div class="row">
      <div class="col-12">
         <div class="page-title-box">
            ...
            <h4 class="page-title">Add Reminder</h4>
         </div>
      </div>
   </div>
   <!-- end page title -->
   <div class="row">
      <div class="col-lg-12 card">
         ...
         <form method="POST" action="{{ route('reminder.store') }}" enctype="multipart/form-data" name="gift_store">
            {{ csrf_field() }}
            <div class="card-body">
               <div class="form-group">
                  <div class="row">
                     ...
                     <div class="col-sm-6 mt-2">
                        ...
                        <input type="text" name="date" class="form-control" required="" placeholder="yyyy-mm-dd">
                     </div>
                     ...
                     <div class="col-sm-6 mt-2">
                        ...
                        <textarea class="form-control" name="content" required="" placeholder="Title"></textarea>
...
<div class="modal fade" id="details" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true">
