...
<div class="navbar-custom">
    ...
    -->
            ...
            // dd($data['count']);
            ?>
            <li class="dropdown notification-list topbar-dropdown hidedisplay">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <i class="fe-bell noti-icon"></i>
                    <span class="badge badge-danger rounded-circle noti-icon-badge">{{$data['count']}}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                    ...
                    <div class="noti-scroll" data-simplebar>
                        ...
                        <!-- <img src="{{\Storage::url('announcment')}}/{{$notification->image}}" style="width: 100px;height:100px"> -->
                        <a href="{{url('admin/notificationSeen')}}/{{$notification->id}}" class="dropdown-item notify-item active" style="background-color:<?php if ($notification->read_status == 1) {
                                                                                                                                                                echo '#c1e5c1';
                                                                                                                                                            } else {
                                                                                                                                                                echo  '#ffc7cf';
                                                                                                                                                            } ?>">
     ...
     -->
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="pro-user-name ml-1">
                        {{auth()->guard('staff')->check() ? auth()->guard('staff')->user()->name : auth()->user()->name}} <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <!-- item-->
                    <a href="{{url('admin/my-account')}}" class="dropdown-item notify-item">
                        <i class="fe-user"></i>
        ...
        <li class="titlename">UCRUISE</li>
            <li class="hidedisplay">
                <button class="button-menu-mobile waves-effect waves-light" type="button">
                    <i class="fe-menu"></i>
                </button>
            </li>
