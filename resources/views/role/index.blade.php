@extends('layouts.vertical', ['title' => 'All Roles'])
                        ...
                        <table class="table table-design-default">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('moduleAccess',[$data->id])}}" class="btn btn-sm btn-info">Access</a>
                                            
                                                <!-- <li title="Delete" style="display:inline-block;"><a href="{{url('/admin/delete-admin',[$data->id])}}" class="btn btn-sm btn-danger"  onclick="return confirm('Are you sure you want to delete this?')"><i class="fas fa-trash" style="cursor: pointer;"></i></a>
                                                </li> -->
